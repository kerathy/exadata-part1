...
import com.example.srsproject.JsonApi;
import com.example.srsproject.R;
import com.example.srsproject.databinding.ActivityGuestInformationBinding;
...
//    CheckBox checkBoxCreateAccount;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityGuestInformationBinding activityGuestInformationBinding = DataBindingUtil.setContentView(this, R.layout.activity_guest_information);
        activityGuestInformationBinding.setGuestViewModel(new GuestViewModel());
        activityGuestInformationBinding.executePendingBindings();
